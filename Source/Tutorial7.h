...
namespace T7 {
	const String tutorialLink = "learnopengl.com/Lighting/Colors";

	const String lightVertexFilename = "T7ColorsVertex.h";
	const String lightFragmentFileName = "T7ColorsFragment.h";

	const String lampVertexFilename = "T7LampVertex.h";
	const String lampFragmentFileName = "T7LampFragment .h";


	struct UniformsTutorial7
	{
		UniformsTutorial7(OpenGLContext& openGLContext, OpenGLShaderProgram& shader)
		{
...
#pragma pack(1)
	struct VertexTutorial6 {
		...
		VertexTutorial6(float x, float y, float z)
		{
			position.x = x;
			position.y = y;
			position.z = z;
...
#pragma pack()
	...
	class SpriteTutorial7
	{
	public:
		SpriteTutorial7(OpenGLContext& openGLContext, Camera& camera, glm::mat4 model = glm::mat4(1.0f)) :VBO(0), VAO(0),
		...
		{
			_uniforms.reset(new UniformsTutorial7(_openGLContext, *shader));
		}
	...
	public:
		...
		std::unique_ptr<UniformsTutorial7> _uniforms;
	...
	class Tutorial7 : public OpenGLAppComponent,
	...
	public:
		...
		void updateShader(ShaderProgram* shaderProg, SpriteTutorial7& sprite)
		{
	...
	private:
		...
		Camera _camera;
		SpriteTutorial7 _spriteLight;
		SpriteTutorial7 _spriteLamp;
		...
		JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(Tutorial7)
	};
}