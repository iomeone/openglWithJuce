...
namespace T11 {
    ...
    const String lightVertexFilename = "T11ColorsVertex.h";
    const String lightFragmentFileName = "T11ColorsFragment.h";
    
    const String lampVertexFilename = "T11LampVertex.h";
    const String lampFragmentFileName = "T11LampFragment.h";
    ...
    struct Uniforms
    {
        ...
        light_direction{ nullptr },  light_ambient{ nullptr }, light_diffuse{ nullptr }, light_specular{ nullptr };
...
//            glDrawArrays(GL_TRIANGLES, 0, 36);
    ...
    class Tutorial11 : public OpenGLAppComponent,
...
//            _camera.ProcessKeyboard(Camera_Movement::LEFT, 1.1f);
...
//            updateShader(_shaderProgramLamp.get(), _spriteLamp);
            ...
            if (_shaderProgramLight->_shader)
            {
                ...
                {
                    if (_spriteLight._uniforms->light_direction)
                    {
                        _spriteLight._uniforms->light_direction->set(-0.2f, -1.0f, -0.3f);
                    }
...
//        std::unique_ptr<ShaderProgram> _shaderProgramLamp;
        ...
        JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(Tutorial11)
    };
}
